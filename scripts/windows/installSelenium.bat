...
if ["%USE_CAPABILITY_MATCHER%"] == ["TRUE"] (
    Powershell.exe -executionpolicy remotesigned Invoke-WebRequest -OutFile grid.jar https://github.com/CoSMoSoftware/KITE-Extras/releases/download/%KITE_EXTRAS_VERSION%/grid-utils-%GRID_VERSION%.jar
)
