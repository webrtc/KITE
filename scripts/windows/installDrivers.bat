...
echo Invoke-WebRequest -OutFile geckodriver.zip https://github.com/mozilla/geckodriver/releases/download/v%GECKO_VERSION%/geckodriver-v%GECKO_VERSION%-win64.zip >> installDrivers.ps1
