...
/** Execution object containing the information of a result of a test case. */
public class Result {
  ...
  /**
   * Constructs a new Result object from given information.
   *
   * @param result a string representing actual result of the test case.
   * @param duration duration of the test case.
   */
  public Result(String result, long duration, boolean stats) {
    this.result = result;
  ...
  public boolean hasBrowser(Browser aBrowser) {
    for (Browser browser : browserList) {
      if (browser.equals(aBrowser)) return true;
    }
    return false;
  }
  /** Sets setBrowserList. */
