...
/**
 * ClientVersionInfo object containing the information as name, version, last version and update
 * time.
 */
public class ClientVersionInfo {
   ...
   */
  public ClientVersionInfo(String name, String version, String lastVersion, String lastUpdate) {
    this.name = name;
