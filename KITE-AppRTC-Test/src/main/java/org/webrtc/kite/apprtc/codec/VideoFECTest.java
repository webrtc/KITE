...
/**
 * VideoFECTest implementation of KiteTest.
 * <p>
 ...
 * stashed earlier.</li>
 * </ul>
 * <li>4) The test is considered as successful if fec is enabled for video (in a m line).</li>
 * <li>5) A successful test returns a boolean 'true' while the unsuccessful test returns a boolean
 * 'false'.</li>
 * </ul>
 * </p>
 */
public class VideoFECTest extends KiteTest {

  private final static Logger logger = Logger.getLogger(VideoFECTest.class.getName());

  private final static String APPRTC_URL = "https://appr.tc/r/";
  private final String value = "true";
  private final String option = "videofec=" + value;
   ...
   *
   * @param sdp local SDP as String
   * @return true if the effect is as expected.
   */
  private boolean validateResults(String sdp) {
