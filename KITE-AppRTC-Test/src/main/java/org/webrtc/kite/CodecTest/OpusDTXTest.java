...
/**
 * OpusDTXTest implementation of KiteTest.
 * <p>
 ...
 * stashed earlier.</li>
 * </ul>
 * <li>4) The test is considered as successful if dtx is enabled/disabled for opus</li>
 * <li>5) A successful test returns a boolean 'true' while the unsuccessful test returns a boolean
 * 'false'.</li>
 * </ul>
 * </p>
 */
public class OpusDTXTest extends KiteTest {

  private final static Logger logger = Logger.getLogger(OpusDTXTest.class.getName());
  ...
  private final String option = "opusdtx=" + value;
