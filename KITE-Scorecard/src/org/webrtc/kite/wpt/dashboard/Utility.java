...
public class Utility {
   ...
   */
  public static String generateTableNameFromBrowser(Browser browser) {
    String version = browser.getVersion().split("\\.")[0];
    if (browser.getName().equalsIgnoreCase("safari") && !browser.getVersion().equalsIgnoreCase("11"))
      version += "." + browser.getVersion().split("\\.")[1];
    return browser.getName() + version + browser.getPlatform().replaceAll(" ", "").replaceAll("\\.", "");
  }
