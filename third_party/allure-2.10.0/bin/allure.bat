...
set APP_HOME=%KITE_HOME%\third_party\allure-2.10.0
...
set CLASSPATH=%APP_HOME%\lib\allure-dependencies.zip;%APP_HOME%\lib\config

@rem Execute allure
start "Allure Server" "%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %ALLURE_OPTS% -classpath "%CLASSPATH%" io.qameta.allure.CommandLine %CMD_LINE_ARGS%
