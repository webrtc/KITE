// With a bit modification by namvuCoSMo @ CoSMo Software Consulting
! function (a) {
    function b(a, b, c) {
        if (8 == g) {
            var d = j.width(),
    ...
    function d() {
        var b = a('<div style="width:50px;height:50px;overflow-y:visible;position:absolute;top:-200px;left:-200px;"><div style="height:100px;width:100%"></div>');
        a("body").append(b);
        var c = b.innerWidth(),
